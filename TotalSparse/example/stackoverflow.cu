...
int main()
{
    ...
    h_A_dense[0] = 0.0f; h_A_dense[4] = 4.0f; h_A_dense[8] = 0.0f; h_A_dense[12] = 0.0f;
    h_A_dense[1] = 0.0f; h_A_dense[5] = 2.0f; h_A_dense[9] = 3.0f; h_A_dense[13] = 0.0f;
    h_A_dense[2] = 0.0f; h_A_dense[6] = 0.0f; h_A_dense[10] = 3.0f; h_A_dense[14] = 7.0f;
    ...
    // --- Host side dense matrix
    double *h_A = (double *)malloc(16 * sizeof(*h_A));
    ...
    double *Test_h_A = (double *)malloc(16 * sizeof(double));
    ...
    Test_h_A[0] = 0.0f; Test_h_A[4] = 4.0f; Test_h_A[8] = 0.0f; Test_h_A[12] = 0.0f;
    Test_h_A[1] = 0.0f; Test_h_A[5] = 2.0f; Test_h_A[9] = 3.0f; Test_h_A[13] = 0.0f;
    Test_h_A[2] = 0.0f; Test_h_A[6] = 0.0f; Test_h_A[10] = 3.0f; Test_h_A[14] = 7.0f;
    Test_h_A[3] = 0.0f; Test_h_A[7] = 0.0f; Test_h_A[11] = 9.0f; Test_h_A[15] = 0.0f;


    dense_to_csr(Test_h_A ,Nrows , Ncols ,  Test_h_A_RowIndices ,Test_h_A_ColIndices);

    // for (int i = 0; i < nnz; ++i) printf("A[%i] = %.0f ", i, Test_h_A[i]); printf("\n");
