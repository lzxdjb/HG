...
using Eigen::Matrix;
    ...
    typedef Matrix<tinytype,   StateShape, StateShape * 2 > UpperDualCache;

     typedef Matrix<tinytype,   StateShape *StateShape * 2 , 1 > SparseUpperDualCache;

    typedef  Matrix<tinytype,   StateShape, 1> RowIndices;

    typedef  Matrix<tinytype,   2 * StateShape * StateShape, 1> ColIndices;   
