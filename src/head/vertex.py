...
class StateVertex():
    ...
    def getGradient(self):
        ...
        if len(self.Gradient) == 0:
            self.Gradient.append ( torch.zeros((StateShape , 1) ,device='cuda' , dtype = torch.float64))
    ...
    def getHessian(self):
        ...
        if len(self.Hessian) == 0:
            self.Hessian.append ( torch.zeros((StateShape , StateShape) ,device='cuda' , dtype = torch.float64))
